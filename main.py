...
SUPPORT_LINK = "https://t.me/legdarknez" # Ссылка на твой аккаунт поддержки
...
async def process_get_vpn(callback_query: types.CallbackQuery):
    await callback_query.message.edit_text(
        ...
        "Мы дарим тебе 3 дня бесплатного доступа, чтобы ты лично проверил космическую скорость нашего VPN.\n\n"
        "🔑 **Твой ключ доступа:**\n"
...
# Запуск процесса опроса бота (Polling)
async def main():
